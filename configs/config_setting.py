...
class setting_config:
    ...
    test_weights = 'UltraLight-VM-UNet-main/results/UltraLight_VM_UNet_ISIC2017_Monday_13_January_2025_20h_24m_00s/checkpoints/best-epoch123-loss0.5255.pth'

    datasets = 'ISIC2017'
    if datasets == 'ISIC2017':
        data_path = '/root/UNet/UltraLight-VM-UNet-main/dataprepare'
    ...
    opt = 'FAdam'
    assert opt in ['Adadelta', 'Adagrad', 'Adam', 'AdamW', 'Adamax', 'ASGD', 'RMSprop', 'Rprop', 'SGD', 'FAdam'], 'Unsupported optimizer!'
    if opt == 'Adadelta':
        ...
        texture_weight = 1.2
        seasonal_adapt = True
        scale_factors = {'small': 1.1, 'medium': 1.0, 'large': 0.9}
